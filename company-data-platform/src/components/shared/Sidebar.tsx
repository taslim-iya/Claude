...
const adminNav: NavItem[] = [
  ...
  },
  {
    label: 'Uploads',
    href: '/admin/uploads',
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" /></svg>,
  },
  {
    label: 'Enrichment',
...
const clientNav: NavItem[] = [
  ...
  {
    label: 'My Criteria',
    href: '/client/criteria',
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>,
  },
  {
    label: 'API Explorer',
    href: '/client/api-explorer',
...
export function Sidebar({ role, userName, onLogout }: { role: 'ADMIN' | 'CLIENT'; userName: string; onLogout: () => void }) {
  ...
  return (
    <aside className="w-64 bg-sidebar-bg text-sidebar-text flex flex-col min-h-screen">
      <div className="p-6 border-b border-white/10">
        <h1 className="text-lg font-bold text-white">Company Data</h1>
        <p className="text-xs text-sidebar-text/60 mt-1">API Platform</p>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-sidebar-text/60 capitalize">{role.toLowerCase()}</p>
          </div>
          <button onClick={onLogout} className="text-sidebar-text/60 hover:text-white" title="Logout">
